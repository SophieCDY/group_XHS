...
group_xhs$IS5_group <- ifelse(group_xhs$IS5 %in% c("Strongly Disagree", "Disagree", "Neither agree nor disagree"),"low", "high")
table(group_xhs$usage_group)
table(group_xhs$IS5_group)
fisher.test(x = group_xhs$IS5_group, y = group_xhs$usage_group)
